const omDomDom = window.omDomDom
 ...
 */
{
  ...
  const node = omDomDom.createNode(view)
  omDomDom.render(node, document.getElementById("test-root-string"))
}

{
  ...
  const node = omDomDom.createNode(temp)
  omDomDom.render(node, document.getElementById("test-root-node"))
}
...

{
  ...
  const node = omDomDom.createNode(view)
  omDomDom.render(node, document.getElementById("test-root-2"))
}
/**
...

{
  ...
  const node = omDomDom.createNode(view)
  omDomDom.render(node, document.getElementById("test-root-3"))
  ...
  document.querySelector("#test3").onclick = () => {
    ...
    const nextNode = omDomDom.createNode(activeView)
    omDomDom.diff(nextNode, node)
    logNode(node)
  }
}
...

{
  ...
  const node = omDomDom.createNode(view)
  omDomDom.render(node, document.getElementById("test-root-4"))
}
...

{
  ...
  const node = omDomDom.createNode(view)
  omDomDom.render(node, document.getElementById("test-root-5"))
...

{
  ...
  const node = omDomDom.createNode(view)
  omDomDom.render(node, document.getElementById("test-root-7"))
...

{
  ...
  const node = omDomDom.createNode(view)
  omDomDom.render(node, document.getElementById("test-root-9"))
...

{
  ...
  const node = omDomDom.createNode(view)
  omDomDom.render(node, document.getElementById("test-root-10"))
...

{
  ...
  const node = omDomDom.createNode(view)
  omDomDom.render(node, document.getElementById("test-root-12"))
...

{
  ...
  const node = omDomDom.createNode(view)
  omDomDom.render(node, document.getElementById("test-root-13"))
...

{
  ...
  const node = omDomDom.createNode(view)
  omDomDom.render(node, document.getElementById("test-root-15"))
...

{
  ...
  const node = omDomDom.createNode(view)
  omDomDom.render(node, document.getElementById("test-root-16"))
...

{
  ...
  const node = omDomDom.createNode(view)
  omDomDom.render(node, document.getElementById("test-root-17"))
...

{
  ...
  const node = omDomDom.createNode(view)
  omDomDom.render(node, document.getElementById("test-root-18"))
